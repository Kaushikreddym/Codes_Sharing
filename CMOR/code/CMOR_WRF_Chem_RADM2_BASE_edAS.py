...
for mon_no in ['09']:
    ...
    if flag_dust == 1:
        ...
        for DATE in datelist:
            ...
            flist = sorted(glob(REL_PATH + DATE + '/' + fname_prefix
                           + '*'))[1:]
            ncfile = [Dataset(f) for f in flist]
            dset1 = getvar(ncfile, 'EDUST1', timeidx=ALL_TIMES,
                          method='cat')
            dset2 = getvar(ncfile, 'EDUST2', timeidx=ALL_TIMES,
                                method='cat')
            dset3 = getvar(ncfile, 'EDUST3', timeidx=ALL_TIMES,
                                method='cat')
            dset4 = getvar(ncfile, 'EDUST4', timeidx=ALL_TIMES,
                                method='cat')
            dset5 = getvar(ncfile, 'EDUST5', timeidx=ALL_TIMES,
                                method='cat')
            
            dset_dust = dset1 + dset2 + dset3 + dset4 + dset5  # .sum(['bottom_top'])
            dset_DA.append(dset_dust)
    ...
    if flag_soil ==1:
        ...
        for DATE in datelist:
            ...
            flist = sorted(glob(REL_PATH + DATE + '/' + fname_prefix
                           + '*'))[1:]
            ncfile = [Dataset(f) for f in flist]
            dset = getvar(ncfile, 'SMOIS', timeidx=ALL_TIMES,
                          method='cat')
            dset_zstag = getvar(ncfile, 'DZS', timeidx=ALL_TIMES,
                                method='cat')
            thickness = dset_zstag
            dset_AOD = dset[:,0,:,:]  # .sum(['bottom_top'])
            dset_DA.append(dset_AOD)
        dset_DA = xray.concat(dset_DA, 'Time')
    ...
    if flag_met == 1:
        ...
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/MET6hourly_3d_varlist')
        ...
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/MET6hourly_2d_varlist')
        for i in range(aerlist.shape[0]):
            dset_DA = []
            for DATE in datelist:
    ...
    if flag_aerosol == 1:
        #'''
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/AER6hourly_3d_varlist')
        for i in range(aerlist.shape[0]):
            dset_DA = []
            dset_z = []
            for DATE in datelist:
        ...
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/AER6hourly_2d_varlist')
        for i in range(aerlist.shape[0]):
        ...
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/AER6hourly_surf_varlist')
    ...
    if flag_cloud == 1:
        ...
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/CLOUD6hourly_3d_varlist')
    ...
    if flag_rad == 1:
        aerlist = pd.read_csv('/home/PartclAeroResLab/kaushik.reddy.m/Codes_Sharing/CMOR/cmor/RAD6hourly_2d_varlist')
        for i in range(aerlist.shape[0]):
            dset_DA = []
            for DATE in datelist:
                print(DATE)
    ...
    if flag_gas == 1:
        ...
        varname_plev=pd.read_csv('/mnt/nas/DATA/kaushik/scripts/github/Codes_Sharing/CMOR/cmor/varname_plev_shortlist.csv')
        varname_sconc=pd.read_csv('/mnt/nas/DATA/kaushik/scripts/github/Codes_Sharing/CMOR/cmor/varname_sconc_shortlist.csv')
